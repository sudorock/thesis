                ...
                if check_collision(particle, particle2):
                    ...
                    for k in range(0, t_iter):
                        ...
                        if np.array_equal(collision_check, table_check1):
                            ...
                            color_change(particle, particle2)
                            c_count2 += 1
                            print("Collision found 1:  ", "Actual data: ", collision_check, "Table data: ", table_check1, "reversed to:", table_check2)
